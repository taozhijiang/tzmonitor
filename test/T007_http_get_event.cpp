#define BOOST_TEST_MODULE http_get_event
...
// 类似namespace的保护
BOOST_AUTO_TEST_SUITE(http_get_event)

BOOST_AUTO_TEST_CASE(http_get_event)
{
    ...
    ss << "version=1.0.0&interval_sec=300&name=callsrvtime";
